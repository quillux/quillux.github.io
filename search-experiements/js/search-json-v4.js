...
The parsetheApi needs to be implemented in the file the scrape page funtion is called
...
.done(function(results) {
    ...
    // this function should be implemented in the page that will consume the API
    // it does not work to simply return as the response is asynchronous

         // check if it has a results block
      var checkSearch = $(".BrowseItem", results).text();
